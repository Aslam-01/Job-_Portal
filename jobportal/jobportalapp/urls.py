...
from jobportalapp.views import UserRegistrationView, UserLoginView,UserPersonalInfoView, UserEducationView, UserExperienceView, UserSkillsView, UserProfileView
